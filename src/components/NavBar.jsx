...
const NavBar = () => {
    return (
        <div className='sticky top-0 left-10 right-0 w-full z-10 h-nav shadow-sm flex flex-col items-center bg-white'>
            ...
            <div className='h-[22%] hidden md:flex flex-row justify-between items-center py-2 px-4 md:px-6'>
                <div className='flex flex-row items-center gap-8'>
                    <img src='achievers.png'/>
                    <CgMenu  className='h-14 w-14'/>
                    <div className='relative flex '>
                        <Dropdown />
                        <input type='search' placeholder='search' className='w-[440px] px-2 py-[2px] border border-1 border-gray-600' />
